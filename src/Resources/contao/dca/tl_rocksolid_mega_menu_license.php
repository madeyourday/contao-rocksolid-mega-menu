...
$GLOBALS['TL_DCA']['tl_rocksolid_mega_menu_license'] = array(
	...
	'config' => array(
		...
		'onsubmit_callback' => array(
			function() {
				Controller::redirect(System::getContainer()->get('router')->generate('contao_backend', ['do' => 'rocksolid_mega_menu', 'ref' => System::getContainer()->get('request_stack')->getCurrentRequest()->attributes->get('_contao_referer_id')]));
			},
		),
	),
