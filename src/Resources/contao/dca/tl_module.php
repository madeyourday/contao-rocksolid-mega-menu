...
$GLOBALS['TL_DCA']['tl_module']['palettes']['rocksolid_mega_menu'] = '{title_legend},name,headline,type;{nav_legend},levelOffset,showLevel,hardLimit,showProtected,showHidden;{reference_legend:hide},defineRoot;{template_legend:hide},navigationTpl,rsmm_template;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID';
